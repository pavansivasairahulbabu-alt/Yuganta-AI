...
const courses = [
	...
	},
	{
		...
		description: "A comprehensive, hands-on journey through the Indian stock market — from Nifty & Sensex basics to advanced options strategies — with live trade simulations and expert mentorship.",
		instructor: "YugantaAI",
		rating: 4.8,
		students: 0,
		lessons: 30,
		...
		level: "Beginner",
		category: "Trading",
		thumbnail: "https://miro.medium.com/v2/resize:fit:1200/1*8K3q3P3R5qJ5L5M5N5O5.jpeg",
		price: "5999",
		isFree: false,
		modules: [
			{
				title: "WEEK 1: Foundations of Indian Financial Markets",
				description: "Understanding NSE, BSE, and Indian market structure.",
				order: 1,
				videos: [
					{ 
						title: "Introduction to Indian Capital Markets & SEBI", 
						url: "https://res.cloudinary.com/demo/video/upload/dog.mp4", 
						publicId: "demo/dog",
						duration: "20:00", 
						order: 1 
			...
			},
			{
				...
				description: "Master candlesticks, support/resistance, and indicators.",
				order: 2,
				videos: [
					{ 
			...
			},
			{
				...
				description: "Learn to read financial statements and analyze sectors.",
				order: 3,
				videos: [
					{ 
			...
			},
			{
				...
				description: "Master derivatives and portfolio protection strategies.",
				order: 4,
				videos: [
					{ 
					...
					{ 
						title: "Trading Plans & Risk Management", 
						url: "https://res.cloudinary.com/demo/video/upload/finish_line.mp4", 
						publicId: "demo/finish_line",
						duration: "28:00", 
						order: 3 
	...
	{
		title: "Indian Market Trade Pro",
		description: "The most comprehensive program for mastering Indian stock market trading. Includes 150+ hours of live mentorship, advanced strategies, and industry-grade trade projects.",
		instructor: "YugantaAI",
		rating: 4.9,
		students: 0,
		lessons: 60,
		...
		modules: [
			{
				...
				description: "Master complex technical analysis patterns and strategies.",
				order: 1,
				videos: [
					{ 
			...
			},
			{
				...
				description: "Deep dive into company analysis and stock valuation.",
				order: 2,
				videos: [
					{ 
					...
					{ 
						title: "Valuation Models & Methods", 
						url: "https://res.cloudinary.com/demo/video/upload/finish_line.mp4", 
						publicId: "demo/finish_line",
						duration: "42:00", 
						order: 2 
