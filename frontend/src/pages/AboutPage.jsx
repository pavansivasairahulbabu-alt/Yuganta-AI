		...
		<>
			...
			<div className="min-h-screen bg-[var(--bg-color)] text-[var(--text-color)] transition-colors duration-300 pt-20">
				...
				<div className="relative py-20 md:py-32 overflow-hidden">
					...
					<div className={`absolute bottom-0 right-1/4 w-96 h-96 bg-[#EC4899] ${isLight ? 'opacity-[0.05]' : 'opacity-10'} rounded-full blur-[120px] animate-pulse`} style={{ animationDelay: '2s' }}></div>
					...
					<div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
						...
						<div className="max-w-4xl">
							...
							<div className="flex flex-wrap gap-4">
								<Link to="/courses" className="px-8 py-4 bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] text-white font-bold rounded-xl hover:shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:scale-105 transition-all duration-300">
									Explore Our Courses
								</Link>
				...
				<div className="max-w-7xl mx-auto px-4 md:px-6 py-20">
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
						<div className="relative group">
							<div className={`absolute -inset-1 bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] rounded-2xl blur ${isLight ? 'opacity-10' : 'opacity-25'} group-hover:opacity-50 transition duration-1000 group-hover:duration-200`}></div>
						...
						<div className="space-y-12">
							...
							<div className="flex gap-6">
								<div className={`flex-shrink-0 w-14 h-14 ${isLight ? 'bg-[#EC4899]/5' : 'bg-[rgba(236,72,153,0.1)]'} rounded-2xl flex items-center justify-center border ${isLight ? 'border-[#EC4899]/20' : 'border-[rgba(236,72,153,0.2)]'}`}>
									<Rocket className="w-8 h-8 text-[#EC4899]" />
								</div>
								<div>
				...
				<div className="bg-[var(--bg-secondary)] py-24 transition-colors duration-300">
					...
					<div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
						{coreValues.map((value, index) => (
							<div key={index} className="p-8 bg-[var(--bg-card)] border border-[var(--border-color)] rounded-3xl hover:border-[#A855F7] transition-all duration-300 group shadow-lg">
				...
				<div className="py-24">
					<div className="max-w-7xl mx-auto px-4 md:px-6">
						<div className="grid grid-cols-2 lg:grid-cols-4 gap-12">
							<div className={`text-center p-8 bg-gradient-to-br ${isLight ? 'from-[#8B5CF6]/10 to-[#8B5CF6]/2 border-[#8B5CF6]/20' : 'from-[rgba(139,92,246,0.05)] to-transparent border-[var(--border-color)]'} rounded-3xl border`}>
								<div className="text-5xl md:text-6xl font-bold mb-4">50+</div>
								<div className="text-[#A855F7] font-bold tracking-wider uppercase text-sm">Projects Delivered</div>
							</div>
							<div className={`text-center p-8 bg-gradient-to-br ${isLight ? 'from-[#EC4899]/10 to-[#EC4899]/2 border-[#EC4899]/20' : 'from-[rgba(236,72,153,0.05)] to-transparent border-[var(--border-color)]'} rounded-3xl border`}>
								<div className="text-5xl md:text-6xl font-bold mb-4">100+</div>
								<div className="text-[#EC4899] font-bold tracking-wider uppercase text-sm">Active Students</div>
							</div>
							<div className={`text-center p-8 bg-gradient-to-br ${isLight ? 'from-[#8B5CF6]/10 to-[#8B5CF6]/2 border-[#8B5CF6]/20' : 'from-[rgba(139,92,246,0.05)] to-transparent border-[var(--border-color)]'} rounded-3xl border`}>
								<div className="text-5xl md:text-6xl font-bold mb-4">15+</div>
								<div className="text-[#A855F7] font-bold tracking-wider uppercase text-sm">Expert Mentors</div>
							</div>
							<div className={`text-center p-8 bg-gradient-to-br ${isLight ? 'from-[#EC4899]/10 to-[#EC4899]/2 border-[#EC4899]/20' : 'from-[rgba(236,72,153,0.05)] to-transparent border-[var(--border-color)]'} rounded-3xl border`}>
								<div className="text-5xl md:text-6xl font-bold mb-4">4.9/5</div>
								<div className="text-[#EC4899] font-bold tracking-wider uppercase text-sm">Student Satisfaction</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div className="max-w-7xl mx-auto px-4 md:px-6 pb-24">
					<div className="bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] rounded-[2rem] p-12 text-center relative overflow-hidden group">
						...
						<div className="relative z-10">
							...
							<div className="flex flex-col sm:flex-row gap-4 justify-center">
								<Link to="/signup" className="px-10 py-4 bg-white text-[#8B5CF6] font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
									Join Now
								</Link>
								<Link to="/contact" className="px-10 py-4 bg-transparent border-2 border-white/30 text-white font-bold rounded-xl hover:bg-white/10 transition-all duration-300">
									Talk to an Expert
								</Link>
							</div>
						</div>
