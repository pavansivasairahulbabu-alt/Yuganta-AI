			...
			<div className='max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8'>
							...
							<div className='flex flex-col lg:flex-row'>
								...
								<div className='lg:w-1/2 p-8 md:p-10 flex flex-col justify-center'>
									...
									<div className='flex flex-col sm:flex-row gap-3 sm:space-x-4'>
										...
										<Link
											to='/mentorships'
											className='px-6 py-3 border border-gray-400 rounded-lg font-semibold hover:bg-white/10 transition text-center'>
											My Mentorships
										</Link>
									</div>
								</div>
				...
				<section className='mb-16'>
					<h2 className='text-3xl font-bold mb-8'>
						{searchQuery ? `Search Results for "${searchQuery}"` : "Learning Path"}
					</h2>
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
						{filteredCourses.length > 0 ? (
							...
							<div className='col-span-full py-12 text-center bg-[var(--card-bg)] rounded-xl border border-dashed border-[var(--border-color)]'>
				...
				{/* Roadmap and Tabs - Hidden when searching */}
				{!searchQuery && (
					<>
						{/* Breadcrumb */}
