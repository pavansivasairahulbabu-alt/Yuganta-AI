        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center text-center gap-8">
            <h1 className={theme === "light-theme"
              ...
              : "text-4xl md:text-5xl lg:text-6xl font-extrabold bg-gradient-to-r from-[#8B5CF6] via-[#EC4899] to-[#06B6D4] bg-clip-text text-transparent"
            }>
      ...
      <section id="expect" className="bg-gradient-to-b from-[var(--bg-primary)] via-[var(--bg-secondary)] to-[var(--bg-primary)] py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-12 md:mb-16">
            ...
            >
              How does the Agentic AI Pioneer Learning Program Help You?
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="rounded-2xl border border-[var(--border-primary)] bg-[var(--card-bg)] p-6 md:p-8 shadow-[0_8px_32px_rgba(139,92,246,0.12)]">
              <h3 className="text-2xl md:text-3xl font-bold text-[var(--text-color)] mb-2">DSA and Machine Learning</h3>
